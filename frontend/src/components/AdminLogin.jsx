...
import { loginAdminWithGoogle } from '../services/firebaseService';
...
const AdminLogin = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (result.success) {
        console.log('✅ Google Sign-In successful:', result.data.email);
        // The AuthContext will handle the authentication state update
      } else {
