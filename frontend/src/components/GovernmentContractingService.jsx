            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  className="bg-white/10 text-white hover:bg-white/20 px-4 sm:px-6 md:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-none border border-white/20 w-full sm:w-auto"
                >
