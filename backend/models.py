...
class AppointmentCreate(BaseModel):
    ...
    appointment_date: str = Field(..., description="Date in YYYY-MM-DD format (user's local timezone)")
    appointment_time: str = Field(..., description="Time in HH:MM format (user's local timezone)")
...
class Appointment(BaseModel):
    ...
    appointment_date: str  # User's local date
    appointment_time: str  # User's local time
    user_timezone: str  # User's timezone
    appointment_datetime_utc: str  # UTC datetime for storage and comparison
    message: Optional[str] = None
