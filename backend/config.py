...
class Settings:
    ...
    if CORS_ORIGINS_STRING == '*':
        ...
        _cors_base = [origin.strip() for origin in CORS_ORIGINS_STRING.split(',') if origin.strip()]
        # Add common development and production origins
        _additional = [
            "http://localhost:3000",
            "http://localhost:3001", 
            "http://127.0.0.1:3000",
            "https://homepage-hero-edit.preview.emergentagent.com",
            "https://lead-g-final.firebaseapp.com",
            "https://lead-g-final.web.app"
        ]
        # Combine and remove duplicates
        CORS_ORIGINS = list(set(_cors_base + _additional))
