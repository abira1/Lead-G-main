...
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://job-page-fix.preview.emergentagent.com
...
env | grep preview
# Output: preview_endpoint=https://job-page-fix.preview.emergentagent.com
```
...
- **Production/Preview:** `https://job-page-fix.preview.emergentagent.com`
