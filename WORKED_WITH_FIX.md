...
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://json-repair-1.preview.emergentagent.com
...
env | grep preview
# Output: preview_endpoint=https://json-repair-1.preview.emergentagent.com
```
...
- **Production/Preview:** `https://json-repair-1.preview.emergentagent.com`
