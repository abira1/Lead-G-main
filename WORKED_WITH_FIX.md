...
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://auth-upload-issue.preview.emergentagent.com
...
env | grep preview
# Output: preview_endpoint=https://auth-upload-issue.preview.emergentagent.com
```
...
- **Production/Preview:** `https://auth-upload-issue.preview.emergentagent.com`
