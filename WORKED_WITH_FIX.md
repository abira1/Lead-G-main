...
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://nav-mobile-patch.preview.emergentagent.com
...
env | grep preview
# Output: preview_endpoint=https://nav-mobile-patch.preview.emergentagent.com
```
...
- **Production/Preview:** `https://nav-mobile-patch.preview.emergentagent.com`
