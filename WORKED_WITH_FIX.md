...
```env
# Backend API URL
REACT_APP_BACKEND_URL=https://lead-generator-21.preview.emergentagent.com
...
env | grep preview
# Output: preview_endpoint=https://lead-generator-21.preview.emergentagent.com
```
...
- **Production/Preview:** `https://lead-generator-21.preview.emergentagent.com`
