...
const getBackendUrl = () => {
  ...
  // - preview.emergentagent.com -> https://json-repair-1.preview.emergentagent.com
...
- ✅ `https://json-repair-1.preview.emergentagent.com/admin`
...
```bash
# Test API health
curl -X GET "https://json-repair-1.preview.emergentagent.com/api/health"

# Test login API
curl -X POST "https://json-repair-1.preview.emergentagent.com/api/admin/login" \
