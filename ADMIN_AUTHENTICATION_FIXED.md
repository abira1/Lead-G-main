...
const getBackendUrl = () => {
  ...
  // - preview.emergentagent.com -> https://codedoc-solution.preview.emergentagent.com
...
- ✅ `https://codedoc-solution.preview.emergentagent.com/admin`
...
```bash
# Test API health
curl -X GET "https://codedoc-solution.preview.emergentagent.com/api/health"

# Test login API
curl -X POST "https://codedoc-solution.preview.emergentagent.com/api/admin/login" \
