...
const getBackendUrl = () => {
  ...
  // - preview.emergentagent.com -> https://job-page-fix.preview.emergentagent.com
...
- ✅ `https://job-page-fix.preview.emergentagent.com/admin`
...
```bash
# Test API health
curl -X GET "https://job-page-fix.preview.emergentagent.com/api/health"

# Test login API
curl -X POST "https://job-page-fix.preview.emergentagent.com/api/admin/login" \
