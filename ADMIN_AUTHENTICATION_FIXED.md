...
const getBackendUrl = () => {
  ...
  // - preview.emergentagent.com -> https://codelib-index.preview.emergentagent.com
...
- ✅ `https://codelib-index.preview.emergentagent.com/admin`
...
```bash
# Test API health
curl -X GET "https://codelib-index.preview.emergentagent.com/api/health"

# Test login API
curl -X POST "https://codelib-index.preview.emergentagent.com/api/admin/login" \
