...
const getBackendUrl = () => {
  ...
  // - preview.emergentagent.com -> https://nav-mobile-patch.preview.emergentagent.com
...
- ✅ `https://nav-mobile-patch.preview.emergentagent.com/admin`
...
```bash
# Test API health
curl -X GET "https://nav-mobile-patch.preview.emergentagent.com/api/health"

# Test login API
curl -X POST "https://nav-mobile-patch.preview.emergentagent.com/api/admin/login" \
