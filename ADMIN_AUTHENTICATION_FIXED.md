...
const getBackendUrl = () => {
  ...
  // - preview.emergentagent.com -> https://index-base.preview.emergentagent.com
...
- ✅ `https://index-base.preview.emergentagent.com/admin`
...
```bash
# Test API health
curl -X GET "https://index-base.preview.emergentagent.com/api/health"

# Test login API
curl -X POST "https://index-base.preview.emergentagent.com/api/admin/login" \
