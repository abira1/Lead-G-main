...
const getBackendUrl = () => {
  ...
  // - preview.emergentagent.com -> https://auth-upload-issue.preview.emergentagent.com
...
- ✅ `https://auth-upload-issue.preview.emergentagent.com/admin`
...
```bash
# Test API health
curl -X GET "https://auth-upload-issue.preview.emergentagent.com/api/health"

# Test login API
curl -X POST "https://auth-upload-issue.preview.emergentagent.com/api/admin/login" \
